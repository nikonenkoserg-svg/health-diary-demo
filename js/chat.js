...
{"kind":"fact|pattern|recap|plan","wake":"ЧЧ:ММ" или null,"events":[{"time":"ЧЧ:ММ","certain":true,"items":[{"product":"торт","portion_g":150,"confidence":"high"}]}]}
...
Если есть сомнения между fact и pattern/recap — выбирай pattern/recap (безопаснее не построить фантомный график, чем построить).
Свежее событие = ОДИН приём пищи + маркер настоящего времени ("только что", "сейчас съел", "20 минут назад"). Длинный пересказ дня — НЕ fact, даже если внутри есть слово "съел".
