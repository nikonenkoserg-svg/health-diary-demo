    ...
    if (typeof Knowledge !== 'undefined') {
      ...
      try {
        if (typeof Time !== 'undefined') {
          ...
          prompt += 'Если пациент удивляется, что время на графике не совпало с каким-то гаджетом — объясни просто: дневник ведёт время по твоей зоне (региону), а не по часам конкретного устройства. На разных гаджетах время может стоять по-разному, зона региона — единый якорь, чтобы замеры не путались и не терялись.\n';
