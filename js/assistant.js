...
[/ПАЦИЕНТ ОПИСАЛ ЕДУ]`;
      ...
      if (glucoseTimeAsk) {
        prompt += '\n\n[ЗАМЕР БЕЗ ВРЕМЕНИ — ВЫСШИЙ ПРИОРИТЕТ]\nПациент назвал сахар, но НЕ сказал, во сколько замерил. Точное время — основа дневника: без него цифра не встаёт на график, дневник теряет смысл.\nПОКА ВРЕМЯ ЭТОГО ЗАМЕРА НЕИЗВЕСТНО твой ответ = ТОЛЬКО короткий вопрос о времени. НЕ давай разбор, НЕ оценивай диапазон, НЕ давай советов, НЕ пересказывай день, НЕ хвали и не комментируй цифру. Одна фраза: «Во сколько замерил?» (если неясен день — уточни и день).\nЭто ВАЖНЕЕ любого разбора еды/дня/пересказа из блоков выше: сначала время, разбор потом.\nКогда пациент назовёт время — примешь и продолжишь. Если ответит «не помню / не засёк» — не дави: цифра сохранится с пометкой «время не названо». Вопрос задаётся ОДИН раз, в следующих репликах не повторяй.\n[/ЗАМЕР БЕЗ ВРЕМЕНИ]';
      }
